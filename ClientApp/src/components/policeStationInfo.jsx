        ...
        return ( 
           ...
           <Row>
               <Col>
                   <Card>
                       <Card.Header>
                       <Card.Title as="h5">Police Station</Card.Title>
                           <span className="d-block m-t-5">Police <code>Station</code> Information</span>
                       </Card.Header>
                       <Card.Body>
                        ...
                        <div className="row">
                            <div className="col-9">
                            {count > 0 ?
                                <h5 className="boder">Show { filtterlength} Police Station in database</h5>:
                                <h5>There are no Police Station in Database</h5> }
                            </div>  
